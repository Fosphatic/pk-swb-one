...
<html class="<?= $params['html_class'] ?>" lang="<?= $intl->getLocaleTag() ?>">
    ...
    <body>
            ...
            <div class="uk-container uk-container-center">
              <nav class="uk-navbar-container" data-uk-navbar>
                <div class="uk-navbar-left">
                    <a class="uk-navbar-brand uk-animation-scale-up" href="<?= $view->url()->get() ?>">
                        <?php if ($params['logo']) : ?>
                            <img class="tm-logo uk-responsive-height uk-preserve" src="<?= $this->escape($params['logo']) ?>" alt="">
                            <img class="tm-logo-contrast uk-responsive-height uk-preserve" src="<?= ($params['logo_contrast']) ? $this->escape($params['logo_contrast']) : $this->escape($params['logo']) ?>" alt="" uk-svg>
                        <?php else : ?>
                            <?= $params['title'] ?>
                        <?php endif ?>
                    </a>
        ...
        <div id="tm-hero" class="tm-hero uk-block uk-block-large uk-cover-container uk-cover-background uk-flex uk-flex-middle <?= $params['classes.hero'] ?>" <?= $params['hero_image'] ? "style=\"background-image: url('{$view->url($params['hero_image'])}');\"" : '' ?> <?= $params['classes.parallax'] ?>>
            <div class="uk-container uk-container-center" uk-scrollspy="cls: uk-animation-slide-bottom-medium; target: > section > div > div > div > * ; delay: 250; repeat: true">
        ...
        <div id="tm-main" class="tm-main uk-block <?= $params['main_style'] ?>">
            <div class="uk-container uk-container-center">
                ...
                <div class="uk-grid-match" data-uk-grid data-uk-margin uk-scrollspy="cls: uk-animation-slide-bottom-medium; target: > main > article > div > * ; delay: 250; repeat: true">
                    ...
                    <aside class="uk-width-1-4 uk-flex uk-height-small <?= $params['sidebar_first'] ? 'uk-flex-first@m' : ''; ?>">
        ...
        <div id="tm-bottom" class="tm-bottom uk-block <?= $params['bottom_style'] ?>">
            <div class="uk-container uk-container-center">
                ...
                <section class="uk-grid-match" data-uk-grid-margin uk-grid>
        ...
        <?php if ($view->position()->exists('footer_a')) : ?>
        <div id="tm-footer-a" class="tm-footer-a uk-section-primary">
            <div class="uk-cover-container uk-container-center">

                <div class="uk-grid-match uk-flex-center" data-uk-grid-margin uk-grid>
                    <?= $view->position('footer_a', 'position-grid.php') ?>
                </div>
        ...
        <div id="tm-footer" class="tm-footer uk-section-secondary uk-contrast">
            <div class="uk-cover-container uk-container-center">
